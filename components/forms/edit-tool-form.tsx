      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="flex items-center">
            <span className="flex-shrink-0 h-9 px-3 flex items-center border border-r-0 border-[#E7E7E7] rounded-l-lg bg-[#FAFAFA] text-[rgba(4,11,77,0.40)] text-sm font-mono select-none">
              /
            </span>
            <input
              id="slug"
              value={tool.slug}
              disabled
              className="h-9 flex-1 rounded-r-lg border border-[#E7E7E7] bg-[#FAFAFA] px-3 text-sm font-mono text-[rgba(4,11,77,0.40)] cursor-not-allowed"
            />
          </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => {
              ...
              setFieldErrors((fe) => ({ ...fe, externalUrl: undefined }))
            }}
          ...
          <div>
            ...
            <Select
              ...
              onChange={(e) => {
                ...
                setFieldErrors((fe) => ({ ...fe, accessLevel: undefined }))
              }}
...
function TagInput({ tags, inputValue, onInputChange, onAdd, onRemove }: TagInputProps) {
  ...
  return (
    <div>
      ...
      <div
        className={cn(
          'flex flex-wrap gap-1.5 min-h-9 w-full rounded-lg border border-[#E7E7E7] bg-white px-2.5 py-1.5',
