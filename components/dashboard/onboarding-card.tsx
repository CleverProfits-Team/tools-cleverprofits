...
export function OnboardingCard({ firstName, toolCount }: OnboardingCardProps) {
  ...
  // Only show for new users who haven't registered tools
  if (toolCount > 0 || dismissed) return null

  return (
    <section className="mb-8 animate-in">
      <div className="relative bg-white rounded-xl border border-[#e2e8f0]/80 shadow-[0_1px_4px_0_rgba(4,11,77,0.06)] overflow-hidden">
        {/* Accent gradient top bar */}
        <div className="h-1 bg-gradient-to-r from-[#2605EF] to-[#6366f1]" />
        ...
        <div className="p-6 flex items-start gap-5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-[#64748b] leading-relaxed mb-4 max-w-lg">
              This is where your team&rsquo;s internal tools live. Browse the tools below to get started,
              or register a tool your team is already using.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button
                ...
                className="text-sm text-[#94a3b8] hover:text-[#64748b] transition-colors font-medium px-2"
              >
                Dismiss
              </button>
            </div>
          ...
          <button
            onClick={() => setDismissed(true)}
            className="p-1 rounded-lg text-[#94a3b8] hover:text-[#64748b] hover:bg-[#f4f3f3] transition-colors flex-shrink-0"
