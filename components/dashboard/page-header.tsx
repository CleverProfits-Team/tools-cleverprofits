...
// ─────────────────────────────────────────────────────────────────────────────
// PageHeader — shared mini-hero used by inner dashboard pages.
// Royal Blue mesh, decorative bubbles, sidebar bleed, bottom fade to bg.
// ─────────────────────────────────────────────────────────────────────────────
...
interface PageHeaderProps {
  ...
  action?:  ReactNode   // e.g. a CTA at the right
}
  ...
  return (
    <div className="-mx-4 sm:-mx-6 lg:-mx-8 -mt-8 mb-8 bg-hero-mesh relative overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(to bottom, transparent, #EEF2FB)' }}
        aria-hidden
      />

      {/* Decorative circle outlines — bubble language */}
      ...
      <div className="relative px-4 sm:px-6 lg:px-8 pt-7 pb-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            {label && (
              <span className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#D5D4FF] mb-1">
                {label}
              </span>
            )}
            <h1 className="font-display font-bold text-[26px] text-white tracking-[-0.02em] leading-none">
              {title}
            </h1>
